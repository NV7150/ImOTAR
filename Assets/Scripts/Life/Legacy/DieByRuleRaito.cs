...
//         if (poseDiff == null)
//             throw new NullReferenceException("DieByRule: poseDiff not assigned");
//         if (dieInput == null)
//             throw new NullReferenceException("DieByRule: dieInput not assigned");
//         if (state == null)
//             throw new NullReferenceException("DieByRule: state not assigned");
//         if (holeCountCS == null)
//             throw new NullReferenceException("DieByRule: holeCountCS not assigned");
