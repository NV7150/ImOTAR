...
//     private Unity.InferenceEngine.Tensor<float> _promptTensorGPU;           // [1,1,H,W]
...
//         _promptTensorGPU = new Unity.InferenceEngine.Tensor<float>(new Unity.InferenceEngine.TensorShape(1, DEPTH_CHANNELS, _dstH, _dstW));
